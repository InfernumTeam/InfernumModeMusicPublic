...
namespace InfernumModeMusic.MusicOverrides
{
    public class ExoMechMusicHandler : ModSceneEffect
    {
        ...
        {
            get => (float)InfernumModeMusic.Infernum.Code.GetType("InfernumMode.InfernumMode").GetField("DraedonThemeTimer").GetValue(null);
            set => InfernumModeMusic.Infernum.Code.GetType("InfernumMode.InfernumMode").GetField("DraedonThemeTimer").SetValue(null, value);
        }
        ...
        public override bool IsSceneEffectActive(Player player) => InfernumModeMusic.Calamity != null && (InfernumModeMusic.CanPlayMusic(InfernumModeMusic.Calamity.Find<ModNPC>("Draedon").Type) || SkyActive);
